...
const GRUPOS_MODULOS: { grupo: string; modulos: string[] }[] = [
  { grupo: 'General', modulos: ['Mis Operaciones', 'Operaciones Activas', 'Pagos', 'Estadísticas', 'Servicios Completados', 'Servicios Cancelados', 'Reportes', 'Catálogos'] },
  ...
  { grupo: 'Configuración', modulos: ['Usuarios', 'Roles y Permisos', 'Historial de Actividad', 'Reglas de Estatus', 'Datos de la Empresa', 'Autorizaciones'] },
