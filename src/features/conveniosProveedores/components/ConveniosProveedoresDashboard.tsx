        ...
        <div className="modal-overlay cpd-x41">
          <div className="form-card detail-card cpd-x42">
            ...
            <div className="cpd-x46">
              ...
              <button type="button" className="ccp-btn-tarifario" title="Exporta el tarifario de este convenio en PDF con el formato oficial (sin clave de servicio)"
                onClick={() => {
                  ...
                  generarTarifarioPDF({
                    etiquetaEntidad: 'PROVEEDOR',
                    entidadNombre: convenioViendo.proveedorNombre || '',
                    monedaEtiqueta,
